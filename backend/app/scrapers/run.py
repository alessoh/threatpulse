...
def seed():
    ...
    seed_threats = [
        {"name": "LockBit 4.0 Ransomware", "severity": "critical", "threat_type": "ransomware",
         ...
         "technical_analysis": "Initial access via CVE-2023-3519 (Citrix NetScaler RCE) and CVE-2024-21762 (Fortinet SSL-VPN). Uses ChaCha20-Poly1305 encryption with RSA-2048 wrapped keys. Deploys via DLL sideloading through legitimate Windows binaries.",
         ...
         "cvss_score": 9.8, "cve_ids": "CVE-2023-3519,CVE-2024-21762", "industries_affected": "Healthcare,Government,Manufacturing"},
        {"name": "Ivanti Connect Secure Zero-Day Chain", "severity": "critical", "threat_type": "zero-day",
         ...
         "cvss_score": 9.1, "cve_ids": "CVE-2023-46805,CVE-2024-21887", "industries_affected": "Government,Defense,Financial"},
